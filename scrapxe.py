...
if __name__ == '__main__':
    ...
    parser.add_argument('--start', default="20190315", help='start date, in YYYYMMDD format. Default is 2014-11-22, the earliest data date for BitMex')
    parser.add_argument('--end', default="20190401", help='end date, in YYYYMMDD format. Default is yesterday')
